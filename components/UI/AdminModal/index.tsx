...
const AdminModal:React.FC<AdminModalProps> = ({isOpen,img,btnText ,onClose,modalTitle="Add Product",formm,modalDescription}) => {
...
<div className='  btn-text'>
            <AddButton shadow center btnSize="w-[400px]" onClick={()=>{
                console.log("adminmodaldaki");
                
            }} btnIcon='' btnText={btnText} btncolor="btn-pink"/>
...
<AddButton shadow center btnSize="w-[400px]" onClick={onClose} btnIcon='' btnText="Cancel" btncolor="modal-div" /></div>
<div className='  btn-text'>
            <AddButton shadow center btnSize="w-[400px]" onClick={addCategory} btnIcon='' btnText={btnText} btncolor="btn-pink"/>
