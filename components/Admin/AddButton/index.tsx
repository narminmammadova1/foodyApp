...
const AddButton = ({btnText,btnIcon="/icons/plus.svg",btncolor,btnSize,center,shadow,onClick}) => {
  ...
  return (
    <>
      ...
      <button onClick={onClick} className={`flex  justify-end ${btnSize} ${shadow ? "custom-shadow": ""}  items-center bg-${btncolor} ${center ?"justify-center": "justify-end"} rounded-lg px-4 py-2 
