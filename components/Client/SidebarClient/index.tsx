...
// }
  ...
  return (
    <div className='w-[251px] h bg-headerbg'>
...
{categoryData?.map((category)=>(
        <li key={category.id} onClick={()=>{
          ...
          // handleFilter()
        }} className='flex gap-4  text-blackli   letter3  cursor-pointer font-mukta  text-[20px]'><img className='  rounded-full ' width="28px" height="28px" src={category?.img_url} alt="" />{category?.name}</li>
